...
const MainContainer = () => {
  return (
    ...
    <div className="py-2 flex-1 gap-6 flex flex-col items-center">
     ...
     <p className=" md:text-left text-base text-textColor">loremmmmmhchgch</p>
     <button  classname="bg-gradient-to-br from-orange-400 from-orange-500 w-full px-4 py-2"type="button">Order Now</button>
